...
const ASSETS = {
  hero: "/assets/hero-broadcast.jpg",
  western: "/assets/game-western.jpg",
  survival: "/assets/game-survival.jpg",
  mark: "/assets/al-mark.png",
};
        ...
        <section className="hero-section">
          ...
          <div className="hero-section__content">
            ...
            <div className="hero-section__actions">
              <a className="signal-button signal-button--primary" href="#queue">Browse the game queue <ArrowDownRight size={18} /></a>
